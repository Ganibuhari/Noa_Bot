...
# model = LlamaForCausalLM.from_pretrained('llama_finetune_checkpoints/checkpoint-1000')
# tokenizer = LlamaTokenizer.from_pretrained('llama_finetune_checkpoints/checkpoint-1000')
